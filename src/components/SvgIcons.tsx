...
export const AlertTriangleIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
...
export const SunIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const MoonIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
export const EyeIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
export const EyeOffIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
export const ChevronRightIcon: React.FC<IconProps> = ({ size = 16, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Polyline
...
export const ArrowLeftIcon: React.FC<IconProps> = ({ size = 16, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const SearchIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const MapPinIcon: React.FC<IconProps> = ({ size = 11, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
export const AlertCircleIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const QrcodeScanIcon: React.FC<IconProps> = ({ size = 20, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const StudentRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    {/* Cap brim */}
    <Path
...
export const TeacherRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    {/* Chalkboard */}
...
export const AdminRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
export const PrincipalRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    {/* Roof / pediment */}
    <Polyline
...
export const ParentRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    <Path
...
// Staff — briefcase
export const StaffRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    {/* Briefcase body */}
...
export const TrainerRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
    {/* Centre bar */}
...
export const DefaultRoleIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const MenuIcon: React.FC<IconProps> = ({ size = 22, color = '#000', style }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={style}>
...
export const ROLE_ICON_MAP: Record<string, React.FC<IconProps>> = {
