...
export const lightColors = {
  ...
  setupCardBg:     '#FFFFFF',
  iconButtonBg:    '#FFFFFF',
  authCardBg:      'transparent',   // auth screen card has no background
  instCardBg:      '#E0ECFF',
  pillBg:          '#EFEFF3',
  arrowBg:         '#F7FAFC',
  statCardDarkBg:  '#1C1C1E',       // stat card dark variant stays dark even in light mode
  ...
  welcomeSub:      '#4B5563',
  logoText:        '#1E3A5F',
  greetingTitle:   '#07305D',       // nameTxt in InstituteSelection
  locationText:    '#787878',
...
export const darkColors = {
  ...
  taglineBlack:    '#B0B0B0',
  taglineOrange:   '#F76C1D',
  taglinePurple:   '#0073FF',  // purple shifts to blue in dark mode for better contrast
  taglineGray:     '#707070',
